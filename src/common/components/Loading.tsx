...
export default function Loading() {
  ...
  const loading = useSelector(
    (state: { loading: { value: string } }) => state.loading.value
  )
  ...
  return (
    <div
      className={`${isLoading} fixed top-0 left-0 z-50 flex h-full w-screen flex-col items-center justify-center bg-white/80 `}
    >
